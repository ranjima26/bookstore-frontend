...
function ViewBook() {
  ...
  const HandlePurchase = async () => {
    const stripe = await loadStripe('pk_test_51ScgVOR0gPSp6RFGSQEt99NILGPhJxz5MDxqNaKQf7Xs4MbTaIBXwVsTZSzDgr3MDroUncEjKt4F6dOuUzuQlEeo00PFkW1VP6');
    console.log(stripe);
    const token = sessionStorage.getItem("token")
    if (token) {
      //reqHeader for jwt middileware
          ...
          <div className='md:grid grid-cols-[1fr_3fr] w-full'>
            ...
            <div className='px-4'>
              ...
              <div className='mt-10 flex justify-end'>
                ...
                <button type='button' onClick={HandlePurchase} className='px-4 py-3 bg-green-800 rounded text-white hover:bg-white hover:text-green-800 hover:border hover:border-green-800 ms-5'>Buy ₹</button>
