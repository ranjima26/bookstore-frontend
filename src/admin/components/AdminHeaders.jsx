        ...
        <>
            <nav className="px-5 py-3 flex items-center">
                ...
                <div className='ms-auto'>
                    ...
                    <button type='button' onClick={handleLogOut} className='flex justify-between items-center border border-black rounded px-3 py-2 ms-3 hover:bg-black hover:text-white'><FaPowerOff className='me-3' />Logout</button>
                </div>
            </nav>
