              ...
              <form className='bg-blue-200 md:p-10 p-5 rounded my-10 md:my-0'>
                ...
                <div className='flex justify-center items-center my-10'>
                  <label htmlFor="editUserProfile">
                    ...
                    {existingProfile == "" ?
                      <img src={preview ? preview : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQb-EBfosem2cEDsnouzXo9DvQMS4Fd-UBOyKcEXPDzUm27cdauaJoyqtmHzsZug98AFYg&usqp=CAU"} alt="profile img" style={{ width: '170px', height: '170px', borderRadius: '50%' }} />
                      :
                      <img src={preview ? preview : `${SERVERURL}/imageuploads/${existingProfile}`} alt="profile img" style={{ width: '170px', height: '170px', borderRadius: '50%' }} />
                ...
                <div className='flex justify-between mt-10'>
                  ...
                  <button type='button' onClick={handleSumbit} className='bg-green-600 text-white rounded p-4 w-1/2 hover:border hover:border-green-600 hover:text-green-600 hover:bg-white ms-3'>Update</button>
                </div>
              </form>
