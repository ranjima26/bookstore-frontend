              ...
              <table className='w-full my-3 shadow'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-500 p-3 text-center'>Ranjima R</td>
                    <td className='border border-gray-500 p-3 text-center'> BSc</td>
                    <td className='border border-gray-500 p-3 text-center'> ranjimar062@gmail.com</td>
                    <td className='border border-gray-500 p-3 text-center'>8590027602</td>
